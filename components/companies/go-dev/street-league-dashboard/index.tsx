	...
	return (
		<div className='flex flex-col justify-center items-center m-28 gap-16'>
			...
			<div className='w-[90%] text-lg flex flex-col gap-2'>
				<p>
					Designed a multi-vendor e-commerce dashboard for a football-centric platform, allowing seamless management of product listings,
					transactions, ground bookings, and user participation in events. The dashboard includes sections for payment tracking, inventory
					management, and a custom design interface for personalized sportswear, streamlining all aspects of the football merchandise and
					activity experience.
				</p>
