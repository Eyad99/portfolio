  ...
  return (
    <div className="flex flex-col justify-center items-center m-28 gap-16">
      ...
      <div className="w-[90%] text-lg flex flex-col gap-2">
        <p>
          Designed to boost student engagement, this project features
          interactive tools like discussion forums, peer-to-peer messaging, and
          group collaboration spaces. It includes a flexible user role
          management system with customizable permissions for administrators,
          instructors, and students. The platform also supports a file
          management system and enables seamless reuse of shareable content from
          various e-learning platforms through SCORM packages.
        </p>
        <Paginate
          text="Next Project"
