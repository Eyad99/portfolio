	...
	return (
		<div className='flex flex-col justify-center items-center m-28 gap-16'>
			...
			<div className='w-[90%] text-lg flex flex-col gap-2'>
				<p>
					This single-vendor e-commerce platform provides a streamlined solution for order management and product display, creating a unique
					and dynamic online shopping experience.{' '}
