  ...
  return (
    <div className="flex flex-col justify-center items-center m-28 gap-16">
      ...
      <div className="w-[90%] text-lg flex flex-col gap-2">
        <p>
          This software system provides a convenient on-demand delivery service
          with door-to-door and package delivery options. It offers features
          such as restaurant reservations, coupons, and discounts to enhance
          user convenience. Users can benefit from a built-in loyalty program
          with gamified rewards, manage their account balances, and access a
          digital wallet. The system also integrates a Delivery Management
          System (DMS) to streamline the ordering and delivery processes
          effectively.{" "}
