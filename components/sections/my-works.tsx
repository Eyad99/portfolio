...
const companies: Project[] = [
  {
    ...
    url: "https://godev.app/",
    description:
      "A dynamic startup delivering cutting-edge web solutions to businesses.",
  },
  {
    ...
    description:
      "A dynamic startup specializing in innovative web development.",
  },
  {
    logo: cubetaLogo.src,
    title: "Cubeta",
    ...
    url: "https://cubeta.io/",
    description:
      "A collective of freelance professionals offering bespoke web solutions.",
  },
  {
    ...
    url: "https://its.ae/",
    description:
      "An emerging tech company specializing in comprehensive IT solutions.",
  },
];
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 ">
          {companies.map((company, index) => (
            ...
            >
              <div
                key={index}
                className="bg-[#2A2E23] rounded-lg p-6 flex flex-col group"
              >
                ...
                <motion.p
                  className="text-sm text-muted-foreground !group-hover:text-blue-400"
