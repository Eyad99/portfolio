...
function MySkills() {
  ...
  const images: { [key: string]: { image: any; alt: string; color: string } } = useMemo(() => {
    ...
    return {
      ...
      [getKey([1285, 1200, 960, 840, 740, 620, 500, 450], ["2-9", "2-8", "3-2", "3-3", "3-1", "3-2", "3-3", "3-4", "4-1"])]: ImagesObj.redux,
      [getKey([1450, 1285, 1200, 960, 840, 740, 620, 500, 450], ["2-10", "3-3", "2-9", "3-3", "3-4", "3-2", "3-3", "3-4", "4-1", "4-2"])]: ImagesObj.zustand,
      [getKey([1450, 1285, 1200, 960, 840, 740, 620, 500, 450], ["3-3", "3-4", "3-2", "3-4", "3-5", "3-3", "3-4", "4-1", "4-2", "4-3"])]: ImagesObj.storyBook,
      [getKey([1450, 1285, 1200, 960, 840, 740, 620, 500, 450], ["3-4", "3-5", "3-3", "3-5", "3-6", "3-4", "3-5", "4-2", "4-3", "5-1"])]: ImagesObj.jest,
      [getKey([1450, 1285, 1200, 960, 840, 740, 620, 500, 450], ["3-5", "3-6", "3-4", "3-6", "4-2", "3-5", "4-1", "4-3", "5-1", "5-2"])]: ImagesObj.cpress,
      [getKey([1450, 1285, 1200, 960, 840, 740, 620, 500, 450], ["3-6", "3-7", "3-5", "3-7", "4-3", "3-6", "4-2", "4-4", "5-2", "5-3"])]: ImagesObj.tailwindCss,
      [getKey([1450, 1285, 1200, 1080, 960, 840, 740, 620, 500, 450], ["3-7", "3-8", "3-6", "3-8", "4-2", "4-4", "4-1", "4-3", "5-1", "5-3", "6-1"])]: ImagesObj.materialUi,
      [getKey([1450, 1285, 1200, 1080, 960, 840, 740, 620, 500, 450], ["3-8", "3-9", "3-7", "4-2", "4-3", "4-5", "4-2", "4-4", "5-2", "5-4", "6-2"])]: ImagesObj.framerMotion,
    };
  }, [width]);
